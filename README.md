...
Go to your GitHub Settings (Click your profile picture -> Settings).
Scroll down the left sidebar and click Developer settings -> Personal access tokens -> Tokens (classic).
Click Generate new token (classic). 
Check the boxes for the repo and workflow scopes.
Copy the token immediately. (You won't be able to see it again! and Do not share this!).

Step 3 : Add the Token to Your Repository Secrets
Go to your forked BabaIsCommit repository.
Click on the Settings -> Secrets and variables -> Actions.
Click the  New repository secret button.
Enter the exact following details:
Name: GH_TOKEN 
Secret: Paste the token you copied in Step 2

Step 4 : Run the GitHub Action
In your forked repository, go to the Actions tabs.
On the left sidebar, click Update Baba Is Commit.
Click the gray Run workflow dropdown on the right, then click the green Run workflow button.

Step 5 : Add Baba to Your Profile README
Go to your special profile repository (YOUR_USERNAME/YOUR_USERNAME) and edit the README.md file.
Paste the following HTML code where you want the animation to appear.
